  ...
  return (
    <ThemeProvider theme={theme}>
      ...
      <ErrorDialog
        ...
        dialogContent={
          `An error occurred when deleting a project. Please try again. If the problem persists, please contact support at ${SUPPORT_EMAIL}.`
        }
      />
    </ThemeProvider>
  );
